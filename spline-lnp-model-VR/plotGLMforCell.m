function [ fighandle ] = plotGLMforCell(fighandle,var_name,posx,speed, max_speed,bl_posx,A,s,all_control_points,spiketrain,spike_idx,trial,params,bestModels,allModelTestFits,parameters)
    figure(fighandle)
    num_plot_columns=3;
